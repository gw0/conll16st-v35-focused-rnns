...
# -*- coding: utf-8 -*-
"""
Random sense classifier of discourse relations (CoNLL16st).
...
class DiscourseParser(object):
    ...
    This simply classifies each instance into a random class.
    """
...
if __name__ == '__main__':
    ...
    if language == 'en':
        ...
        select_from_senses = valid_senses  # select from all senses
    elif language == 'zh':
